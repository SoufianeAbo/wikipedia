        ...
        <div class="flex flex-wrap items-center ml-2">
            <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
                <a href="#" aria-label="Home">
                    <img class = "w-1/4" src="../img/whitelogo.png" alt="">
                </a>
            </div>
        </div>
...
<main class = "overflow-x-hidden">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <section>
            <div id="main" class="main-content flex-1 bg-gray-100 w-fit md:w-[105%] h-screen mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="flex flex-wrap">
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600 text-white"><i class="fa-solid fa-newspaper fa-2xl"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-black">Total Articles</h2>
                                   <p class="font-bold text-3xl text-black">$3249</p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600 text-white"><i class="fa-solid fa-list fa-2xl"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-black">Total Categories</h2>
                                   <p class="font-bold text-3xl text-black">$3249</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600 text-white"><i class="fa-solid fa-tags fa-2xl"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-black">Total Categories</h2>
                                   <p class="font-bold text-3xl text-black">$3249</p>
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600 text-white"><i class="fa-solid fa-users fa-2xl"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-black">Total Categories</h2>
                                   <p class="font-bold text-3xl text-black">$3249</p>
