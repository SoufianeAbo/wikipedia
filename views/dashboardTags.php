...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 border-r border-gray-200 sm:translate-x-0 bg-gray-800 border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/wikis/index" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/wikis/tags" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/users/register" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<button onclick = "my_modal_5.showModal()" class="btn btn-success fixed bottom-0 right-0 m-4 z-50"><i class="fa-solid fa-layer-group"></i>Add tag</button>
<div class = "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
<?php foreach ($tags as $tag) { ?>
  <div class="card w-96 bg-base-100 shadow-xl">
    <div class="card-body">
        <h2 class="card-title"><?= $tag['tag'] ?></h2>
        <p><?php echo $categoryNames[$tag['categoryId']] ?></p>

        <div class="card-actions justify-end">
        <button onclick = "modifyModal_<?php echo $tag['id']?>.showModal()" class="btn btn-primary"><i class="fa-solid fa-pen"></i>Modify</button>
